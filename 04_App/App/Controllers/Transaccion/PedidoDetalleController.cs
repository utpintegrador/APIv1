...
namespace App.Controllers.Transaccion
{
    ...
    public class PedidoDetalleController : ControllerBase
    {
        ...
        [HttpGet("ObtenerPorIdPedido/{idPedido}", Name = "ObtenerPedidoDetallePorIdPedido")]
        [ProducesResponseType(typeof(ResponsePedidoDetalleObtenerPorIdPedidoDto), 404)]
        [ProducesResponseType(typeof(ResponsePedidoDetalleObtenerPorIdPedidoDto), 200)]
        public async Task<ActionResult<ResponsePedidoDetalleObtenerPorIdPedidoDto>> ObtenerPorIdPedido(long idPedido)
        {
            ...
            respuesta.CantidadTotalRegistros = entidad.Count();
